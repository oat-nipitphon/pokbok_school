        ...
        <div class="col-md-10">
            <div class="row">
                ...
                <div class="card-body" style="background-color: #f8c0e0;">
                    ...
                    {{-- <div class="row">
                        <div>
                            <a href="{{ route('edit.ita', $ita->id) }}" class="btn btn-sm btn-warning" style="font-size: 0.8em;">แก้ไข</a>
                            <a href="{{ route('delete.ita', $ita->id) }}" class="btn btn-sm btn-danger" style="font-size: 0.8em;" id="deleteCompany" data-id="{{ $ita->id }}">
                                ลบ
                             </a>
                        </div>
                        <div>
                            <button type="submit" class="btn btn-info" onclick="window.location.href='{{ route('delete.ita', $ita->id) }}'">แก้ไข
                                {{ $ita->id }}</button>
                        ...
                        <div class="ibox-content">
                            <div class="col-md-12">
                                <div class="row" style="margin-top: 30px;">
                                    <label id="fontTitleDetail" class="text-center">
                                ...
                                {{-- <div class="row">
                                    ...
                                    <div class="col-md-10 text-center">
                                        <label style="margin-bottom: 20px;">
                                            <img id="" src="/image/{{ $ita->image_ita }}" alt="" width="550" height="750">
                                        </label>
                                    </div>
                                    <div class="col-md"></div>
                                </div> --}}
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <label id="">
                                            <embed src="/files/{{ $ita->duc_file }}" width="850px" height="850px" />
                                        </label>
                                    </div>
                                    <div class="col-md"></div>
                                </div>
                                <div class="row" style="margin-top: 30px;">
                                    @if (Auth::user())
                                        <div class="col-md-6">
                                            <a href="{{ route('edit.ita', $ita->id) }}" class="btn btn-lg btn-warning" style="font-size: 1em; margin-left: 20px;">แก้ไข</a>
                                            <a href="{{ route('delete.ita', $ita->id) }}" class="btn btn-lg btn-danger" style="font-size: 1em; margin-left: 10px;" id="deleteCompany" data-id="{{ $ita->id }}">
                                                ลบ
                                            </a>
                                        </div>
                                    @else
